...
# system deps: ffmpeg (аудио), curl (скачать Piper), libgomp1 (нужен faster-whisper)
RUN apt-get update && apt-get install -y ffmpeg curl libgomp1 && rm -rf /var/lib/apt/lists/*
